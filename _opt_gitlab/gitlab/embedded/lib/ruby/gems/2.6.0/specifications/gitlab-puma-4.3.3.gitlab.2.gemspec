...
Gem::Specification.new do |s|
  s.name = "gitlab-puma".freeze
  s.version = "4.3.3.gitlab.2"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "changelog_uri" => "https://gitlab.com/gitlab-org/gitlab-puma/blob/gitlab-latency/History.md", "msys2_mingw_dependencies" => "openssl" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["GitLab".freeze, "Evan Phoenix".freeze]
  s.date = "2020-03-04"
