# -*- encoding: utf-8 -*-
# stub: gitlab-puma_worker_killer 0.1.1.gitlab.1 ruby lib

Gem::Specification.new do |s|
  s.name = "gitlab-puma_worker_killer".freeze
  s.version = "0.1.1.gitlab.1"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Richard Schneeman".freeze, "GitLab".freeze]
  s.date = "2019-12-11"
  s.description = " Kills pumas, the code kind ".freeze
  s.email = ["richard.schneeman+rubygems@gmail.com".freeze, "kamil@gitlab.com".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<gitlab-puma>.freeze, [">= 2.7", "< 5"])
      ...
      s.add_dependency(%q<gitlab-puma>.freeze, [">= 2.7", "< 5"])
