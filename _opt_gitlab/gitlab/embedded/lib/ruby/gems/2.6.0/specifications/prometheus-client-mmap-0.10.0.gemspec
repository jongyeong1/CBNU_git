# -*- encoding: utf-8 -*-
# stub: prometheus-client-mmap 0.10.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<fuzzbert>.freeze, ["~> 1.0", ">= 1.0.4"])
      s.add_development_dependency(%q<gem_publisher>.freeze, ["~> 1"])
      ...
      s.add_dependency(%q<fuzzbert>.freeze, ["~> 1.0", ">= 1.0.4"])
      s.add_dependency(%q<gem_publisher>.freeze, ["~> 1"])
