# -*- encoding: utf-8 -*-
# stub: acme-client 2.0.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<bundler>.freeze, ["~> 1.6", ">= 1.6.9"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10.0"])
      s.add_development_dependency(%q<rspec>.freeze, [">= 3.3.0", "~> 3.3"])
      s.add_development_dependency(%q<vcr>.freeze, ["~> 2.9", ">= 2.9.3"])
      s.add_development_dependency(%q<webmock>.freeze, ["~> 3.3"])
      s.add_runtime_dependency(%q<faraday>.freeze, ["~> 0.9", ">= 0.9.1"])
    else
      s.add_dependency(%q<bundler>.freeze, ["~> 1.6", ">= 1.6.9"])
      s.add_dependency(%q<rake>.freeze, ["~> 10.0"])
      s.add_dependency(%q<rspec>.freeze, [">= 3.3.0", "~> 3.3"])
      s.add_dependency(%q<vcr>.freeze, ["~> 2.9", ">= 2.9.3"])
      s.add_dependency(%q<webmock>.freeze, ["~> 3.3"])
      s.add_dependency(%q<faraday>.freeze, ["~> 0.9", ">= 0.9.1"])
    end
  else
    s.add_dependency(%q<bundler>.freeze, ["~> 1.6", ">= 1.6.9"])
    s.add_dependency(%q<rake>.freeze, ["~> 10.0"])
