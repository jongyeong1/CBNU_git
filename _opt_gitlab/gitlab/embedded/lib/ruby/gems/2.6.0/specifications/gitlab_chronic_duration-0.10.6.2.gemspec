# -*- encoding: utf-8 -*-
# stub: gitlab_chronic_duration 0.10.6.2 ruby lib

Gem::Specification.new do |s|
  s.name = "gitlab_chronic_duration".freeze
  s.version = "0.10.6.2"
  ...
  s.homepage = "https://gitlab.com/gitlab-org/gitlab-chronic-duration".freeze
