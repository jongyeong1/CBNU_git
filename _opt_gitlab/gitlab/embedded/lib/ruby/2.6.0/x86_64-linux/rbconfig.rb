...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/gitlab/embedded' '--without-ext=dbm,readline' '--enable-shared' '--disable-install-doc' '--without-gmp' '--without-gdbm' '--without-tk' '--disable-dtrace' '--with-opt-dir=/opt/gitlab/embedded' 'CFLAGS=-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe' 'LDFLAGS=-Wl,-rpath,/opt/gitlab/embedded/lib -L/opt/gitlab/embedded/lib' 'CPPFLAGS=-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe' 'CXXFLAGS=-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe'"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -I/opt/gitlab/embedded/include $(DEFS) $(cppflags)"
  ...
  CONFIG["CFLAGS"] = "-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -fPIC"
  CONFIG["CC"] = "gcc"
